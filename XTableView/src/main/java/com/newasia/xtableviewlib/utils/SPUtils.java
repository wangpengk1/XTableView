...
public final class SPUtils {
    ...
    private static final String SPNAME = "APP_INFO";
    ...
    {
        SPUtils.putString(SPUtils.getSharedPreferences(SPNAME,s_Context),key,value);
    }

    public static String getSettting(String key)
    {
        return SPUtils.getString(SPUtils.getSharedPreferences(SPNAME,s_Context),key,"");
    }
     ...
     * @return
     */
    public static SharedPreferences getSharedPreferences(String spName,Context context) {
